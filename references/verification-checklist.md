...
**Skip this whole section if no setup notebook was emitted** — i.e. the Step 1 data-source decision was "real tables already exist" and the bundle reads them directly. These items apply only when synthetic data was fabricated.
